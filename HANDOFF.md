...
Le projet est en **v6.15 (2 onglets — Marchés + Veille sport business)** depuis le 27/04/2026 (enrichissement automatique de la `dateLimite` pour les liens `achatpublic.com` — fetch supplémentaire de la page détail pour récupérer "Date limite de remise des plis" + parsing FR→ISO).
