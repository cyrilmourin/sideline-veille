...
Le projet est en **v6.14 (2 onglets — Marchés + Veille sport business)** depuis le 27/04/2026 (resserrage du filtre titre fédération : on n'accepte plus le mot "appel" seul, qui matchait des expressions idiomatiques type "appel du large", "appel à l'aide", "lance l'appel" — seulement les formes prépositionnelles explicites d'AO).
