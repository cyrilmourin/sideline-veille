...
Le projet est en **v6.17 (2 onglets — Marchés + Veille sport business)** depuis le 27/04/2026 : ajout des 3 cosmétiques P3 — favicon fallback (pastille dorée si Google S2 retourne du vide), libellé de catégorie dans le modal détail, et extension de `WHITELIST_EMETTEURS_LOCAUX_FR` avec 14 métropoles régionales + 19 départements importants (Île-de-France au complet, Nord/PdC, Rhône, Bouches-du-Rhône, Haute-Garonne, Gironde, Var, Alpes-Maritimes, Isère, Hérault, Ille-et-Vilaine, Loire-Atlantique). 194 entrées au total (+74).
